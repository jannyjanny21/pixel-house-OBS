...
const morePackages = [
   {
      name: 'DUO',
      price: '₱900',
      description: 'Self shoot 2-person session, great for couples',
      duration: '15 mins session',
      features: ['Unlimited edited photos', 'Online gallery'],
      people: 'Max 2 persons',
   },
   {
      name: 'GROUP',
      price: '₱1,500',
      description: 'Self shoot session for larger friend groups',
      duration: '25 mins session',
      features: ['Unlimited edited photos', 'Online gallery', 'Priority slot'],
      people: 'Max 10 persons',
   },
   {
      name: 'EVENT',
      price: '₱2,000',
      description: 'Extended session for birthdays and small events',
...
export default function HomePage() {
   ...
   const compactPackages = packages.filter((pkg) => !pkg.featured)
                        ...
                        <div>
                           ...
                           <div className="mt-6 space-y-3 text-sm text-slate-200">
                              ...
                              <div className="flex items-center gap-3">
                                 ...
                                 <span>{featuredPackage.people}</span>
                              </div>
                           </div>
                        </div>
